...
class HorizontalContainer : public UIRect {
  public:
    ...
    HorizontalContainer(const std::string &name = "HorizontalContainer")
        : UIRect(name) {}
    ...
    virtual void Deserialize(json &j) override {
        ...
        if (j.contains("m_Padding"))
            j.at("m_Padding").get_to(m_Padding);
        if (j.contains("m_Gap"))
            j.at("m_Gap").get_to(m_Gap);
        if (j.contains("m_ShowRegion"))
            j.at("m_ShowRegion").get_to(m_ShowRegion);
        if (j.contains("m_Arrangement"))
            j.at("m_Arrangement").get_to(m_Arrangement);
    }
    ...
    virtual void OnInspectorRender() override {
        ...
        if (ImGui::TreeNodeEx("HorizontalContainer",
            ...
            if (ImGui::TreeNodeEx("m_Arrangement",
                                  ImGuiTreeNodeFlags_DefaultOpen)) {
                if (ImGui::Button("Right")) {
                    m_Arrangement = Direction::Right;
                    RearrangeChildren();
                }
                if (ImGui::Button("Left")) {
                    m_Arrangement = Direction::Left;
                    RearrangeChildren();
                }
                if (ImGui::Button("Center")) {
                    m_Arrangement = Direction::Center;
                    RearrangeChildren();
                }
                ImGui::TreePop();
            }
    ...
    void SetHeightFromChildren() {
        ...
        for (auto &child : m_Children) {
            if (UIRect *rect = dynamic_cast<UIRect *>(child)) {
                if (rect->m_Size.y > maxHeight)
                    maxHeight = rect->m_Size.y;
            }
        }
        m_Size.y = maxHeight;
    }
    ...
    void RearrangeChildren() {
        ...
        if (m_Arrangement == Left) {
            ...
            // items, with a max of the border of the HorizontalContainer
