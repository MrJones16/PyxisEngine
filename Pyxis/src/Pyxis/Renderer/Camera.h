...
class Camera {
  public:
    ...
    virtual glm::vec2 GetOffsetToGrid() const { return m_OffsetToGrid; }

    void LockAspect() { m_LockAspect = true; }
    void UnlockAspect() { m_LockAspect = false; }

    void SetRenderResolution(const glm::ivec2 &RenderResolution) {}
    glm::vec2 GetRenderResolution() const { return m_RenderResolution; }
  ...
  protected:
    ...
    // addition to the 2d camera size
    glm::vec2 m_RenderResolutionBuffer = glm::vec2(2, 2);

    glm::mat4 m_ProjectionMatrix = glm::mat4(1);
    glm::mat4 m_ViewMatrix = glm::mat4(1);
    glm::mat4 m_ViewProjectionMatrix = glm::mat4(1);

    glm::vec2 m_Size = glm::vec2(640, 360);
...
class OrthographicCamera : public Camera {
  public:
    OrthographicCamera(float width, float aspect, float nearClip,
                       float farClip);
    ...
    // void SetProjectionMatrix(float width, float height, ) const override {
    // return m_ProjectionMatrix; }
