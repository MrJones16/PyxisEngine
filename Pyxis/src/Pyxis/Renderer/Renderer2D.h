...
namespace Pyxis
{
	...
	public:
		...
		static void DrawTextLine(const std::string& text, glm::mat4 transform, Ref<Font> font, const glm::vec2& maxSize, float fontSize = 20.0f, UI::Direction alignment = UI::Direction::Center, bool scaleToFit = true, const glm::vec4& color = { 0,0,0,1 }, uint32_t nodeID = 0);
