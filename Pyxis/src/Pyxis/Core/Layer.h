...
class PYXIS_API Layer {
  public:
    ...
    /// <summary>
    /// OnDetach does not get invoked when the application gets deleted.
    /// Instead, the layer's destructor is called
    /// </summary>
  ...
  private:
    /*
       ...
       WindowMoved, AppTick, AppUpdate, AppRender, KeyPressed, KeyReleased,
