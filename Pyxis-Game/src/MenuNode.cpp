...
MenuNode::MenuNode(const std::string &name)
    : Node(name), m_CallbackRichPresenceJoinRequested(
                      this, &MenuNode::OnGameRichPresenceJoinRequested),
...
{
    // since I don't have scenes to set up an actual heirarchy, and an editor to
    // do things scenes are set in a constructor...
    glm::vec4 themeYellow =
    ...
    canvasNode->CreateTextures("assets/textures/UI/GreenCanvas/",
    ...
    // logo
    auto logo =
        Instantiate<UI::UIRect>(ResourceManager::Load<Texture2DResource>(
                                    "assets/textures/UI/InsetPyxisLogo.png"),
                                "Logo");
    logo->m_PPU = 0.25f;
    ...
    {
        // name
        auto nameInput = Instantiate<UI::InputText>(
            "Name Text Input",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            &m_PlayerName);
        nameInput->m_FontSize = 5;
        nameInput->m_TextureResource = ResourceManager::Load<Texture2DResource>(
            "assets/textures/UI/TextPlate.png");
        nameInput->m_TextureResourceSelected =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/TextPlateSelected.png");
        ...
        // colorCanvas->CreateTextures("assets/textures/UI/GreenCanvas/",
        // "GreenCanvasTile_", ".png"); colorCanvas->m_PPU = 64;
        // colorCanvas->m_Size = { 512, 128 };
        // container->AddChild(colorCanvas);

        // color select container
        auto colorSelectContainer =
            Instantiate<UI::Container>("Color Select Container");
        colorSelectContainer->m_VerticalAlignment = UI::Direction::Center;
        /*		colorSelectContainer->m_AutomaticSizing = true;
                        colorSelectContainer->m_AutomaticSizingOffset = {
           -48,-48 };*/
        ...
        auto colorRedInput = Instantiate<UI::InputInt>(
            "Color Red Input",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            &m_PlayerColor[0]); // &red color
        colorRedInput->m_MaxValue = 255;
        colorRedInput->m_MinValue = 0;
        colorRedInput->m_FontSize = 5;
        colorRedInput->m_TextureResource =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/TextPlateSmall.png");
        colorRedInput->m_TextureResourceSelected =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/TextPlateSmallSelected.png");
        ...
        auto colorGreenInput = Instantiate<UI::InputInt>(
            "Color Green Input",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            &m_PlayerColor[1]); // &Green color
        colorGreenInput->m_MaxValue = 255;
        colorGreenInput->m_MinValue = 0;
        colorGreenInput->m_FontSize = 5;
        colorGreenInput->m_TextureResource =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/TextPlateSmall.png");
        colorGreenInput->m_TextureResourceSelected =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/TextPlateSmallSelected.png");
        ...
        auto colorBlueInput = Instantiate<UI::InputInt>(
            "Color Blue Input",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            &m_PlayerColor[2]); // &Blue color
        colorBlueInput->m_MaxValue = 255;
        colorBlueInput->m_MinValue = 0;
        colorBlueInput->m_FontSize = 5;
        colorBlueInput->m_TextureResource =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/TextPlateSmall.png");
        colorBlueInput->m_TextureResourceSelected =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/TextPlateSmallSelected.png");
    ...
    // multiplayer button
    {
        auto multiButton = Instantiate<UI::TextButton>(
            "Join Friends Button",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            std::bind(&MenuNode::PlayMultiplayer, this));
        multiButton->m_PPU = 0.25f;
        multiButton->m_Text = "Join Friend";
        multiButton->m_TextColor = themeYellow;
        multiButton->Translate({0, 0, 1});
        multiButton->m_TextureResource =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/ButtonWide.png");
        multiButton->m_TextureResourcePressed =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/ButtonWidePressed.png");
    ...
    {
        auto horizContainer =
            Instantiate<UI::HorizontalContainer>("Connect&IP HContainer");
        ...
        auto multiButton = Instantiate<UI::TextButton>(
            "Join LAN Button",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            std::bind(&MenuNode::PlayLAN, this));
        multiButton->m_PPU = 0.25f;
        ...
        // IP Input
        auto IPInput = Instantiate<UI::InputText>(
            "IP Input",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            &m_InputAddress);
        IPInput->m_FontSize = 5;
        IPInput->m_TextureResource = ResourceManager::Load<Texture2DResource>(
            "assets/textures/UI/TextPlate.png");
        IPInput->m_TextureResourceSelected =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/TextPlateSelected.png");
        IPInput->m_PPU = 0.25;
    ...
    // Host Game button
    {
        auto hostButton = Instantiate<UI::TextButton>(
            "Host Game Button",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            std::bind(&MenuNode::HostGameP2P, this));
        hostButton->m_PPU = 0.25f;
        hostButton->m_Text = "Host Game";
        hostButton->m_TextColor = themeYellow;
        hostButton->Translate({0, 0, 1});
        hostButton->m_TextureResource =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/ButtonWide.png");
        hostButton->m_TextureResourcePressed =
            ResourceManager::Load<Texture2DResource>(
                "assets/textures/UI/ButtonWidePressed.png");
    ...
    // Host LAN Game button
    {
        auto hostButton = Instantiate<UI::TextButton>(
            "Host LAN Button",
            ResourceManager::Load<Font>("assets/fonts/Aseprite.ttf"),
            std::bind(&MenuNode::HostGameIP, this));
        hostButton->m_PPU = 0.25f;
    ...
    // manually calling the propagate update so the container and canvas can do
    // their thing :)
...
void MenuNode::OnUpdate(Timestep ts) {
    if (auto colorDisplay = m_PlayerColorDisplay.lock()) {
        colorDisplay->m_Color = glm::vec4(
            (float)m_PlayerColor[0] / 255.0f, (float)m_PlayerColor[1] / 255.0f,
            (float)m_PlayerColor[2] / 255.0f, (float)m_PlayerColor[3] / 255.0f);
    }
}
...
void MenuNode::PlayLAN() {
    // Get steam identity, create a multiplayer instance, and connect, and kill
    // menu node.
    auto MultiplayerGame = Instantiate<MultiplayerGameNode>();
    MultiplayerGame->m_ClientData.m_Color = glm::vec4(
        (float)m_PlayerColor[0] / 255.0f, (float)m_PlayerColor[1] / 255.0f,
        (float)m_PlayerColor[2] / 255.0f, (float)m_PlayerColor[3] / 255.0f);
...
void MenuNode::QuitGame() { Application::Get().Close(); }

void MenuNode::FailedToConnect() {}

void MenuNode::OnGameRichPresenceJoinRequested(
    GameRichPresenceJoinRequested_t *pCallback) {
